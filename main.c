...
/*int main(void)
{
	...
	ft_printf("\n\n===Testing chars===\n\n");
	count1 = ft_printf("Printing a char: %c\n", 'A');
	count2 = printf("Printing a char: %c\n", 'A');
	ft_printf("\n_Number of bytes printed_\noriginal: %d\nmine:     %d\n", count2, count1);

	int count1 = 0;
	int count2 = 0;

	count1 = ft_printf("Printing a NULL: %c\n", 0);
	count2 = printf("Printing a NULL: %c\n", 0);
	ft_printf("\n_Number of bytes printed_\noriginal: %d\nmine:     %d\n", count2, count1);
}*/


// Not my work improve mine taking inspiration from this one
